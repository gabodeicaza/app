// SynCo · Layout del Sub-coordinador con Bottom Tabs (paridad con (spec)).
// Tabs: Noticias · Inicio · Nuevo · Mensajes · Calendario.
...
export default function SubCoordLayout() {
  ...
  return (
    ...
    >
      ...
      />
      {/* Pantalla legacy: el dashboard real ya se sirve mediante index.tsx (re-export). */}
